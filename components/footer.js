        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          ...
          <div>
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              ...
              {navigation.map((item, index) => (
                <Link key={index} href={links.map((link) => link, index)} className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700">                 
                    {item}
                </Link>     
              ))}
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100089453528872"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://www.instagram.com/systemtec3030/"
                target="_blank"
                rel="noopener">
              ...
              <a
                href="https://www.linkedin.com/in/anderson-leite-730b13152/"
                target="_blank"
                rel="noopener">
